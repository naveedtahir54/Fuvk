...
os.system('xdg-open https://youtube.com/@killerstylish70/')
...
\x1b[1;92m NAME HOGA 😂BADNAME TO HOGA NA 😎 

\x1b[1;92m -------------------------------------------------------------------

 \x1b[1;92m      TERI BAJI KA X ALI ASAD

----------------------------------------------

 Author    : Naveed X SHERAZ

 Github    : TNaveed555

 FACEBOOK   : BRANDED DEVIL

 Tool Name : Naveed HO BSDK
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        tks = ("Hi ASAD Sir, I Need To Buy Your Paid Prince PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def pak():
                ...
                with tred(max_workers=30) as ASAD:     
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [ASAD-😎] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ASAD=session.cookies.get_dict().keys()
